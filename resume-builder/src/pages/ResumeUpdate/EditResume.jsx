  ...
  return (
    <DashboardLayout>
      <div className="container mx-auto px-4 md:px-0">
        {/* Header Actions */}
        <div className="flex items-center justify-between gap-3 md:gap-5 glass-card rounded-2xl border border-purple-200/50 py-4 px-4 md:px-6 mb-6 hover:shadow-xl transition-all duration-300">
          <TitleInput
          ...
          <div className="flex items-center gap-2 md:gap-3 flex-shrink-0">
            <button
              className="glass-card border-2 border-purple-300 text-purple-700 px-3 md:px-4 py-2 rounded-xl font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300 flex items-center gap-2 text-sm"
            ...
            <button 
              className="glass-card border-2 border-red-300 text-red-600 px-3 md:px-4 py-2 rounded-xl font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300 flex items-center gap-2 text-sm" 
            ...
            <button
              className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white px-3 md:px-4 py-2 rounded-xl font-semibold hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center gap-2 text-sm animate-gradient"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
          {/* Form Section */}
          <div className="glass-card rounded-2xl border border-purple-200/50 overflow-hidden shadow-xl">
            ...
            <div className="mx-4 md:mx-5">
              {errorMsg && (
                <div className="flex items-center gap-2 text-xs font-medium text-amber-700 bg-amber-100 px-3 py-2 my-2 rounded-lg border border-amber-200">
                  <CircleAlert className="w-4 h-4 flex-shrink-0" /> 
                  <span>{errorMsg}</span>
                </div>
              )}

              <div className="flex items-end justify-end gap-2 md:gap-3 mt-4 mb-5">
                <button
                  className="glass-card border-2 border-purple-300 text-purple-700 px-3 md:px-4 py-2 rounded-xl font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300 flex items-center gap-2 text-sm"
                  onClick={goBack}
                  disabled={isLoading}
                ...
                <button
                  className="glass-card border-2 border-green-300 text-green-700 px-3 md:px-4 py-2 rounded-xl font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300 flex items-center gap-2 text-sm"
          ...
          {/* Preview Section */}
          <div ref={resumeRef} className="h-[100vh] sticky top-24">
            <div className="glass-card p-4 rounded-2xl h-full overflow-auto custom-scrollbar border border-purple-200/50 shadow-xl">
              <RenderResume
